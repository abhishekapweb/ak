...
if(isset($_POST['submit'])){
	...
	header("Location:add-partner.php?message=1");
	} }else{
	$iPageId = $_REQUEST['id'];
	$oProduct->getPartner($iPageId);
	...
	$iPageInsertId	       =	$oGeneral->update_data($sTableName,'fld_id', $aData,$iPageId);
				header("Location:add-partner.php?id={$iPageId}&message=2&type=edit");
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="forms-basic.html">Partner</a>
							<i class="icon-angle-right"></i>
						</li>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> Partner</h3>
							</div>
							<div class="box-content nopadding">
								<form  method="POST" class='form-horizontal form-striped' enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="fld_partner" value="<?=$aSubCategory[0]['fld_partner']?>" id="textfield" placeholder="Partner Name" class="input-xlarge">
										</div>
									</div>
									
									
									<div class="control-group">
										<label for="textfield" class="control-label">Partner Image</label>
										<div class="controls">
