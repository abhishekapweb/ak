...
$oCategory->getUser();
$aUser = $oCategory->aResults;
$iUser = $oCategory->iResults;
...
<head>
    ...
    <style>.emailuser{width:8% !important;}</style>
</head>
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="manage-category.php">Manage Customer</a>
							<i class="icon-angle-right"></i>
						</li>
					...
					<div class="span12">
						<div class="box box-color box-bordered">
							...
							<table class="table table-hover table-nomargin dataTable">
									...
									<tbody>
										  <?php for($i=0;$i < $iUser;$i++){?>
													<tr id="row<?=$aUser[$i]['fld_id']?>">
														<td><?=$aUser[$i]['fld_username']?></td>
														<td><?=$aUser[$i]['fld_country']?></td>
														<td><?=$aUser[$i]['fld_mobile']?></td>
														<td><?=$aUser[$i]['fld_vc_no']?></td>
														<td><?=$aUser[$i]['fld_country']?></td>
														<td><?=$aUser[$i]['fld_country']?></td>
													</tr>
                                                    <?php } ?>
