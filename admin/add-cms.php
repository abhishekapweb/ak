...
if(isset($_POST['submit'])){
	...
	header("Location:add-cms.php?message=1");
	} }else{
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> CMS</h3>
							 </div>
							 <div class="box-content nopadding">
								...
								<form  method="POST" class='form-horizontal form-striped form-wysiwyg' enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" name="fld_meta_title" value="<?=$aChannel[0]['fld_meta_title']?>" id="textfield" placeholder="Meta Title" class="input-xlarge span12">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Meta Keyword</label>
										<div class="controls">
											<input type="text" name="fld_meta_keyword" value="<?=$aChannel[0]['fld_meta_keyword']?>" id="textfield" placeholder="Meta Keyword" class="input-xlarge span12">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Meta Discription</label>
										<div class="controls">
											<input type="text" name="fld_meta_discription" value="<?=$aChannel[0]['fld_meta_discription']?>" id="textfield" placeholder="Meta Discription" class="input-xlarge span12">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="fld_title" value="<?=$aChannel[0]['fld_title']?>" id="textfield" placeholder="Title" class="input-xlarge span12">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="fld_discription" id="textarea" rows="5" class="ckeditor span12"><?=$aChannel[0]['fld_discription']?> </textarea>
										</div>
									</div>
