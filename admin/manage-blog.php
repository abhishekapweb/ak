...
<head>
    ...
    function removeList(id)
	{
		 var x= confirm("Are you sure delete?");
			...
			$.post( "delete-blog.php?id="+id, function( data ) {
                                          ...
                                          $aSubCategory = $oCategory->aResults;
										 	?>
													<tr id="row<?=$aCategory[$i]['fld_id']?>">
														...
														<td><a class="btn menu-icon  vd_bd-grey vd_success" href="add-blog.php?id=<?=$aTrip[$i]['fld_id']?>&type=edit">Edit</a>&nbsp;<a class="btn menu-icon  vd_bd-grey vd_grey" onClick="removeList(<?=$aTrip[$i]['fld_id']?>);">Delete</a></td>
													</tr>
                                                    <?php } ?>
