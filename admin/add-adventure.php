...
if(isset($_POST['submit'])){
	...
	header("Location:add-adventure.php?message=1");
	} }else{
	...
	$iPageInsertId	       =	$oGeneral->update_data($sTableName,'fld_id', $aData,$iPageId);
				header("Location:add-adventure.php?id={$iPageId}&message=2&type=edit");
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="forms-basic.html">Adventure</a>
							<i class="icon-angle-right"></i>
						</li>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> Adventure</h3>
							 </div>
							...
							<ul class="tabs tabs-inline tabs-top">
								...
								<form  method="POST" class='form-horizontal form-striped' enctype="multipart/form-data">
									...
									<div class="control-group">
										<label for="textfield" class="control-label">Adventure</label>
										<div class="controls">
											<input type="text" name="fld_trip" value="<?=$aChannel[0]['fld_trip']?>" id="textfield" placeholder="Adventure" class="input-xlarge">
										</div>
									</div>
