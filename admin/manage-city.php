...
<head>
    ...
    function removeList(id)
	{
		 var x= confirm("Are you sure delete?");
			...
			$.post( "delete-trip.php?id="+id, function( data ) {
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="manage-trip.php">Manage Trip</a>
							<i class="icon-angle-right"></i>
						</li>
                                          ...
                                          $aSubCategory = $oCategory->aResults;
										 	?>
													<tr id="row<?=$aTrip[$i]['fld_id']?>">
														...
														<td><a class="btn menu-icon  vd_bd-grey vd_success" href="add-trip.php?id=<?=$aTrip[$i]['fld_id']?>&type=edit">Edit</a>&nbsp;<a class="btn menu-icon  vd_bd-grey vd_grey" onClick="removeList(<?=$aTrip[$i]['fld_id']?>);">Delete</a></td>
													</tr>
                                                    <?php } ?>
