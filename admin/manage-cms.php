...
<head>
    ...
    function removeList(id)
	{
		 var x= confirm("Are you sure delete?");
			...
			$.post( "delete-cms.php?id="+id, function( data ) {
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="manage-cms.php">Manage CMS</a>
							<i class="icon-angle-right"></i>
						</li>
                                          ...
                                          $aSubCategory = $oCategory->aResults;
										 	?>
													<tr id="row<?=$aCategory[$i]['fld_id']?>">
														...
														<td><a class="btn menu-icon  vd_bd-grey vd_success" href="add-cms.php?id=<?=$aTrip[$i]['fld_id']?>&type=edit">Edit</a>&nbsp;<a class="btn menu-icon  vd_bd-grey vd_grey" onClick="removeList(<?=$aTrip[$i]['fld_id']?>);">Delete</a></td>
													</tr>
                                                    <?php } ?>
