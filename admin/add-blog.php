...
if(isset($_POST['submit'])){
	...
	$sTableName = 'tbl_blog';
		...
		if($iImageId != "")
...

			{
                ...
                if($sReturn == '0'){
                	 $upload_img = $oGeneral->cwUpload('../uploads/',$sDatabaseFileName,'../uploads/blog/','938','450');
	...
	header("Location:add-blog.php?message=1");
	} }else{

      $iPageId = $_REQUEST['id'];
	$oProduct->getBlog($iPageId );
	...
	$iPageInsertId	       =	$oGeneral->update_data($sTableName,'fld_id', $aData,$iPageId);
				header("Location:add-blog.php?id={$iPageId}&message=2&type=edit");
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="forms-basic.html">Blog</a>
							<i class="icon-angle-right"></i>
						</li>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> Blog</h3>
							 </div>
							 <div class="box-content nopadding">
								...
								<form  method="POST" class='form-horizontal form-striped form-wysiwyg' enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="fld_tags" value="<?=$aChannel[0]['fld_tags']?>" id="textfield" placeholder="Trip" class="input-xlarge">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Date</label>
										<div class="controls">
											<input type="text" name="fld_date" value="<?=$aChannel[0]['fld_date']?>" id="textfield" placeholder="Tags" class="input-xlarge">
										</div>
									</div>
