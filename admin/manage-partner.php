...
<head>
    ...
    function removeList(id)
	{
		 var x= confirm("Are you sure delete?");
			...
			$.post( "delete-partner.php?id="+id, function( data ) {
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="manage-partner.php">Manage Partner</a>
							<i class="icon-angle-right"></i>
						</li>
										 ...
										 <?php for($i=0;$i < $iTrip;$i++){
										 	...
										 	?>
													<tr id="row<?=$aTrip[$i]['fld_id']?>">
														...
														<td><?=$aTrip[$i]['fld_partner']?></td>
														
														
														<td><a class="btn menu-icon  vd_bd-grey vd_success" href="add-partner.php?id=<?=$aTrip[$i]['fld_id']?>&type=edit">Edit</a>&nbsp;<a class="btn menu-icon  vd_bd-grey vd_grey" onClick="removeList(<?=$aTrip[$i]['fld_id']?>);">Delete</a></td>
													</tr>
                                                    <?php } ?>
